...
locals {
  ...
  stack_config_secret_id = "/runs-on/${var.stack_name}/config"
  ...
  stack_config_json = jsonencode({
    ...
    LaunchTemplateLinuxDefaultNested   = var.launch_template_linux_default_nested_id
    LaunchTemplateWindowsDefault       = var.launch_template_windows_default_id
    LaunchTemplateWindowsDefaultNested = var.launch_template_windows_default_nested_id
    LaunchTemplateLinuxPrivate         = var.launch_template_linux_private_id
    LaunchTemplateLinuxPrivateNested   = var.launch_template_linux_private_nested_id
    LaunchTemplateWindowsPrivate       = var.launch_template_windows_private_id
    LaunchTemplateWindowsPrivateNested = var.launch_template_windows_private_nested_id
  ...
  all_env_vars = merge(
    {
      ...
      RUNS_ON_STACK_CONFIG_SECRET_VERSION = aws_secretsmanager_secret_version.runs_on_stack_config.version_id

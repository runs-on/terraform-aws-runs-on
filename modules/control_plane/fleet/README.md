...
| <a name="input_runtime"></a> [runtime](#input\_runtime) | Fleet ECS runtime settings | <pre>object({<br/>    image              = string<br/>    size               = string<br/>    log_retention_days = number<br/>  })</pre> | n/a | yes |

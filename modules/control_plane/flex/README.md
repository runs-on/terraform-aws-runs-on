...
| <a name="input_alerts"></a> [alerts](#input\_alerts) | Flex alert delivery settings | <pre>object({<br/>    email             = string<br/>    slack_webhook_url = string<br/>    slack_bot_token   = string<br/>    slack_channel_id  = string<br/>  })</pre> | n/a | yes |

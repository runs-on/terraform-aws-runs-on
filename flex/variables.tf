...
variable "app_image" {
  ...
  type        = string
  default     = "public.ecr.aws/c5h5o9k1/runs-on/runs-on:v3.0.0-rc.3@sha256:e2232379eb12d88e42fc40ae317fc1f00dae1dc86cb8a71ab4f4e64103cbe532"
  nullable    = false
}
...
variable "app_size" {
  description = "Preset for the worker service, default EC2 launch concurrency, and default JIT registration concurrency. Allowed values: small, medium, high, xhigh."
  type        = string
  default     = "small"
...
variable "app_custom_policy_arn" {
  description = "Optional managed IAM policy ARN to attach to the RunsOn worker service role."
  type        = string
  default     = ""
}

...
function manifestForPrimary(setupState) {
  const url = baseUrl();
  return {
    ...
    public: false,
    redirect_url: url + '/setup/convert?state=' + encodeURIComponent(setupState),
...
function manifestForBoost(idFactory, setupState) {
  const url = baseUrl();
  ...
  return {
    ...
    public: false,
    redirect_url: url + '/setup/apps/convert?state=' + encodeURIComponent(setupState),
...
function renderSetupPage(licenseKey, idFactory, now) {
  ...
  const manifest = manifestForPrimary(setupState);
...
function renderAppsPage(state, idFactory, licenseKey, now) {
  ...
  const boostManifest = manifestForBoost(idFactory, setupState);

...
variable "app_size" {
  description = "Preset for the Fleet worker service, default EC2 launch concurrency, and default JIT registration concurrency. Allowed values: small, medium, high, xhigh."
  type        = string
  default     = "small"

...
variable "app_image" {
  ...
  type        = string
  default     = "public.ecr.aws/c5h5o9k1/runs-on/runs-on:v2.12.4-rc.1@sha256:78320345076b8b50210b40222a4ab7aab7762388cc478bf038397724b5946184"
  nullable    = false
}

...
variable "app_image" {
  ...
  type        = string
  default     = "public.ecr.aws/c5h5o9k1/runs-on/runs-on:v2.12.8-rc.1@sha256:4a9084cf8f133e3d2e9697d8c249036a0f67ca5e27a21d77922ef33ea2b2b3e0"
  nullable    = false
}

...
variable "app_image" {
  ...
  type        = string
  default     = "public.ecr.aws/c5h5o9k1/runs-on/runs-on:v2.12.5-rc.1@sha256:7f1445c4acc497300ba616b9fd95da7f34131e309c70f04f6d8a8a978da34d0c"
  nullable    = false
}

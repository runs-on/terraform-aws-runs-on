...
variable "app_image" {
  ...
  type        = string
  default     = "public.ecr.aws/c5h5o9k1/runs-on/runs-on:v2.12.7-rc.1@sha256:404752cc635ee57e8bc34fd3c2a06fe3e97b53129a53f14121a7750bd5c37cc2"
  nullable    = false
}

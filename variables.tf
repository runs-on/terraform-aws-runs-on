...
variable "app_image" {
  ...
  type        = string
  default     = "public.ecr.aws/c5h5o9k1/runs-on/runs-on:v2.12.9-rc.2@sha256:2377803e3bf9ce890f28a40493c65e83a5a4bc8ec39ef5e222629f781c31c9e0"
  nullable    = false
}

...
variable "app_image" {
  ...
  type        = string
  default     = "public.ecr.aws/c5h5o9k1/runs-on/runs-on:v2.12.5-rc.2@sha256:ac32b5217b5cd38e37744c02091337f099517adbde57e95511196529b6a372da"
  nullable    = false
}

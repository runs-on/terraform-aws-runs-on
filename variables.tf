...
variable "app_image" {
  ...
  type        = string
  default     = "public.ecr.aws/c5h5o9k1/runs-on/runs-on:v2.12.6-rc.1@sha256:57b788d7bf4f731a11d3435d5951ff49c338ce14ec45ebc0b8503216c2026ca7"
  nullable    = false
}
